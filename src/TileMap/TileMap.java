...
public class TileMap
{
	...
	public void loadTiles(String tileSetFile) throws IOException
	{
		...
		tiles[1][1] = new Tile(tileset.getSubimage(32, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][2] = new Tile(tileset.getSubimage(64, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][3] = new Tile(tileset.getSubimage(96, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][4] = new Tile(tileset.getSubimage(128, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][5] = new Tile(tileset.getSubimage(160, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][6] = new Tile(tileset.getSubimage(192, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][7] = new Tile(tileset.getSubimage(224, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][8] = new Tile(tileset.getSubimage(256, 32, 32, 32),
				Tile.BLOCKED);
		tiles[1][9] = new Tile(tileset.getSubimage(288, 32, 32, 32),
				Tile.BLOCKED);
